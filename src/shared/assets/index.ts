...
export { default as spinner } from './images/tube-spinner.svg';
export { default as header_logo } from './images/header_logo.svg';
export { default as deezer } from './images/deezer.svg';
export { default as apple_music_about } from './images/apple_music_about.svg';
export { default as share_music } from './images/share_music.svg';
export { default as find_track } from './images/find_track.svg';
